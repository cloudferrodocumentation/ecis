...
.. figure:: my-organization-ecis.png
   :class: image-with-border

When your account is created, the operator usually enters the initial organization data during onboarding. You can later review this information and update it if needed.
...
* manage organization members in :doc:`/accountmanagement/Sub-accounts`,
* review pending access requests in :doc:`/accountmanagement/Invitations/Invitations`,
* check billing-related information in :doc:`/accountmanagement/Cloud-projects-wallets/Cloud-projects-wallets`,
* contact the operator through :doc:`/accountmanagement/Help-Desk-And-Support/Help-Desk-And-Support` if any organization data cannot be changed from the portal.