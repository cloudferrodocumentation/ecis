...
.. jinja:: brand_names
   ...
   The list of user roles on OpenStack is in article :doc:`/cloud/OpenStack-user-roles-on-{{ brand_name_hyphen }}/OpenStack-user-roles-on-{{ brand_name_hyphen }}`
...
Application credentials give access to all activated regions and you have to specify which one to use. Specify it as the value of parameter **\-\-os-region**, for instance **ECIS-R1** or **ECIS-R2**.
...
.. jinja:: brand_names
   ...
   :doc:`/cloud/OpenStack-user-roles-on-{{ brand_name_hyphen }}/OpenStack-user-roles-on-{{ brand_name_hyphen }}`
