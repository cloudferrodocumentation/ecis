...
.. figure:: s3-keys-menu-ecis-portal.png
...
.. figure:: do-you-want-to-generate-ecis-portal.png
   :class: image-with-border
...
.. figure:: r1-s3-keys-generated-ecis-portal.png
   :class: image-with-border

You will see a message at the top center of the window:

.. figure:: copied-r1-s3-keys-ecis-portal.png
   :class: image-with-border
...
.. figure:: modal-window-reset-key-ecis-portal.png
   :class: image-with-border
