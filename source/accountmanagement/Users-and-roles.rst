...
A Tenant Manager role, on the other hand, controls what the user can do in the Tenant Manager and across organization services. It defines whether the user can manage the organization, invite and manage users, access billing-related information, manage S3 keys, or use organization services.
...
**admin**
   ...
   Can manage their own S3 keys, providing full control over S3 resources within the organization account. Full control over object operations such as uploading, modifying, and deleting objects inside assigned buckets.


**member+**
   Corresponds to *Corresponds to *Corresponds to **Service/App Memberplus**.
...
.. figure:: users-and-roles--portal.png
...
.. jinja:: caption_colors
   ...
   .. list-table:: :{{ caption }}:`Tenant Manager menu options available to all roles`
      ...
      * - :{{ header }}:`Menu group`
        - :{{ header }}:`Menu options`
      * - **Services**
        - **Active services**, **Service Catalog**, **Regions**
      * - **Configuration**
        - **My profile**, **Organization**
      * - **Support**
        - **Notifications**, **Tickets**
      * - **Management Interfaces**
        - **Managed Kubernetes**, **R1 Cloud Panel**, **R2 Cloud Panel**, **ELA Cloud Panel**
...
.. jinja:: caption_colors
   ...
   .. list-table:: :{{ caption }}:`S3 permissions by Tenant Manager role`
      ...
      * - **admin**
        - **s3object-admin**
        - Full control over S3 resources within the organization account.
      * - **member+**
        - **s3object-memberplus**
        - Can upload, modify, and delete objects inside assigned buckets, but cannot change global S3 configuration.
      * - **member**
        - **s3object-member**
        - Does not have the **S3 Keys** option in Tenant Manager.

OpenStack access by Tenant Manager role
---------------------------------------

Tenant Manager roles are connected with OpenStack roles, but they are not assigned in Horizon. Tenant Manager roles are assigned by an **admin** in the **Users and Roles** page of the Tenant Manager.
