...
.. jinja:: brand_names
   ...
   To have the OpenStack CLI client configured and operational, see article: :doc:`/openstackcli/How-to-install-OpenStackClient-for-Linux-on-{{ brand_name_hyphen }}`.
...
Images uploaded within your account
   ...
   .. jinja:: brand_names
      ...
      :doc:`/cloud/How-to-upload-your-custom-image-using-OpenStack-CLI-on-{{ brand_name_hyphen }}`
...
.. jinja:: brand_names
    ...
    :doc:`/openstackcli/How-to-create-a-set-of-VMs-using-OpenStack-Heat-Orchestration-on-{{ brand_name_hyphen }}`

    :doc:`/openstackcli/How-to-transfer-volumes-between-domains-and-projects-using-OpenStack-CLI-client-on-{{ brand_name_hyphen }}`

    :doc:`/openstackcli/How-to-move-data-volume-between-two-VMs-using-OpenStack-CLI-on-{{ brand_name_hyphen }}`
