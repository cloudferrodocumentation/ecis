...
.. jinja:: brand_names
   ...
   If you want to select a different size for the System Volume (Root Disk) please read article :doc:`/cloud/VM-created-with-option-Create-New-Volume-Yes-on-{{ brand_name_hyphen }}/VM-created-with-option-Create-New-Volume-Yes-on-{{ brand_name_hyphen }}`.
