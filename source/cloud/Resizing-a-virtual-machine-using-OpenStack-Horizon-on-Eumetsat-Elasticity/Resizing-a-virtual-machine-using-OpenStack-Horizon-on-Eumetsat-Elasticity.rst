...
.. jinja:: brand_names
   ...
   You can also resize the virtual machine using only OpenStack CLI. More details here: :doc:`/openstackcli/Resizing-a-virtual-machine-using-OpenStack-CLI-on-{{ brand_name_hyphen }}/Resizing-a-virtual-machine-using-OpenStack-CLI-on-{{ brand_name_hyphen }}`