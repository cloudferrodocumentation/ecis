...
CF_REMOTE = "https://github.com/CloudFerro/"
...
CF3 = CF_REMOTE + REMOTE + blob
KUBERNETES = CF_REMOTE + "kubernetes-doc" + blob

EUMETSAT_ELASTICITY = CF_LOCAL + LOCAL + blob
...
urls_dict = get_files(
  {
    ...
    "accountmanagement": [
         ...
         "kubernetes": [
            ...
            KUBERNETES + "How-To-Install-OpenStack-and-Magnum-Clients-for-Command-Line-Interface-to-Eumetsat-Elasticity-Horizon",
            KUBERNETES + "How-To-Use-Command-Line-Interface-for-Kubernetes-Clusters-On-Eumetsat-Elasticity-OpenStack-Magnum",
            KUBERNETES + "How-To-Access-Kubernetes-Cluster-Post-Deployment-Using-Kubectl-On-Eumetsat-Elasticity-OpenStack-Magnum",
            KUBERNETES + "Using-Dashboard-To-Access-Kubernetes-Cluster-Post-Deployment-On-Eumetsat-Elasticity-OpenStack-Magnum",
            KUBERNETES + "How-To-Create-API-Server-LoadBalancer-for-Kubernetes-Cluster-On-Eumetsat-Elasticity-OpenStack-Magnum",
            KUBERNETES + "Creating-Additional-Nodegroups-in-Kubernetes-Cluster-on-Eumetsat-Elasticity-OpenStack-Magnum",
            KUBERNETES + "Autoscaling-Kubernetes-Cluster-Resources-on-Eumetsat-Elasticity-OpenStack-Magnum",
            KUBERNETES + "Volume-based-vs-Ephemeral-based-Storage-for-Kubernetes-Clusters-on-Eumetsat-Elasticity-OpenStack-Magnum",
            KUBERNETES + "Backup-of-Kubernetes-Cluster-using-Velero",
			KUBERNETES + "Kubernetes-Persistent-Volume-Claims-on-Eumetsat-Elasticity",
			KUBERNETES + "Using-Kubernetes-Ingress-on-Eumetsat-Elasticity-WAW3-1-OpenStack-Magnum",
            KUBERNETES + "Deploying-Helm-Charts-on-Magnum-Kubernetes-Clusters-on-Eumetsat-Elasticity-WAW3-1-Cloud",
            KUBERNETES + "Deploying-HTTPS-Services-on-Magnum-Kubernetes-in-Eumetsat-Elasticity-WAW3-1-Cloud",
            KUBERNETES + "Installing-HashiCorp-Vault-on-Eumetsat-Elasticity-WAW3-1-Magnum",
            KUBERNETES + "Installing-JupyterHub-on-Magnum-Kubernetes-cluster-in-Eumetsat-Elasticity-WAW3-1-cloud",
            KUBERNETES + "Install-and-run-Argo-Workflows-on-Eumetsat-Elasticity-WAW3-1-Magnum-Kubernetes",
            KUBERNETES + "HTTP-Request-based-Autoscaling-on-K8S-using-Prometheus-and-Keda-on-Eumetsat-Elasticity",
            KUBERNETES + "Default-Kubernetes-cluster-templates-in-Eumetsat-Elasticity-Cloud",
            KUBERNETES + "Accessing-EODATA-from-Kubernetes-pods-in-Eumetsat-Elasticity-WAW3-1-cloud-using-boto3",
            KUBERNETES + "Create-and-access-NFS-server-from-Kubernetes-on-Eumetsat-Elasticity",
            KUBERNETES + "Deploy-Keycloak-on-Kubernetes-with-a-sample-app-on-Eumetsat-Elasticity",
            KUBERNETES + "Install-and-run-Dask-on-a-Kubernetes-cluster-in-Eumetsat-Elasticity-cloud",
            KUBERNETES + "Install-and-run-NooBaa-on-Kubernetes-cluster-in-single-and-multicloud-environment-on-Eumetsat-Elasticity",
            KUBERNETES + "Private-container-registries-with-Harbor-on-Eumetsat-Elasticity-Kubernetes",
            KUBERNETES + "Deploying-vGPU-workloads-on-Eumetsat-Elasticity-Kubernetes",
            KUBERNETES + "Kubernetes-cluster-observability-with-Prometheus-and-Grafana-on-Eumetsat-Elasticity",
            KUBERNETES + "Enable-Kubeapps-app-launcher-on-Eumetsat-Elasticity-Magnum-Kubernetes-cluster",
            KUBERNETES + "Install-GitLab-on-Eumetsat-Elasticity-Kubernetes",
            KUBERNETES + "Sealed-Secrets-on-Eumetsat-Elasticity-Kubernetes",
            KUBERNETES + "CICD-pipelines-with-GitLab-on-Eumetsat-Elasticity-Kubernetes-building-a-Docker-image",
            KUBERNETES + "How-to-create-Kubernetes-cluster-using-Terraform-on-Eumetsat-Elasticity",
            KUBERNETES + "GitOps-with-Argo-CD-on-Eumetsat-Elasticity-Kubernetes",
            KUBERNETES + "Configuring-IP-Whitelisting-for-OpenStack-Load-Balancer-using-Horizon-and-CLI-on-Eumetsat-Elasticity",
            KUBERNETES + "Configuring-IP-Whitelisting-for-OpenStack-Load-Balancer-using-Terraform-on-Eumetsat-Elasticity",
            KUBERNETES + "Implementing-IP-Whitelisting-for-Load-Balancers-with-Security-Groups-on-Eumetsat-Elasticity",
            KUBERNETES + "How-to-install-Rancher-RKE2-Kubernetes-on-Eumetsat-Elasticity-cloud",
