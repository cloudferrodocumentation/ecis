...
.. jinja:: brand_names
   ...
   Choose or generate SSH keypair :doc:`/cloud/How-to-create-key-pair-in-OpenStack-Dashboard-on-{{ brand_name_hyphen }}` for your VM. Next, launch your instance by clicking on blue button.
...
.. jinja:: brand_names
   ...
   If you want to make your VM accessible from the Internet check :doc:`/networking/How-to-Add-or-Remove-Floating-IPs-to-your-VM-on-{{ brand_name_hyphen }}`.
